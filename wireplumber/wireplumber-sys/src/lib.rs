...
use libspa_sys::{spa_dict, spa_json, spa_log, spa_pod, spa_type_info};
use pipewire_sys::{pw_context, pw_core, pw_impl_node, pw_properties, pw_proxy};
...
pub const WP_SPA_TYPE_INVALID: c_int = -1;
...
// Callbacks
pub type WpIteratorFoldFunc = Option<
...
pub type WpRuleMatchCallback = Option<
    unsafe extern "C" fn(
        gpointer,
        *const c_char,
        *mut WpSpaJson,
...
>;
pub type WpSettingsChangedCallback =
    Option<unsafe extern "C" fn(*mut WpSettings, *const c_char, *mut WpSpaJson, gpointer)>;
...
pub struct WpComponentLoaderInterface {
    ...
    pub supports_type:
        Option<unsafe extern "C" fn(*mut WpComponentLoader, *const c_char) -> gboolean>,
    pub load: Option<
        unsafe extern "C" fn(
            *mut WpComponentLoader,
            *mut WpCore,
            *const c_char,
            *const c_char,
            *mut WpSpaJson,
...
impl ::std::fmt::Debug for WpEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpEvent @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpIterator {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpIterator @ {self:p}")).finish()
    }
}
...
pub struct WpIteratorMethods {
    ...
    >,
    pub foreach:
        Option<unsafe extern "C" fn(*mut WpIterator, WpIteratorForeachFunc, gpointer) -> gboolean>,
...
pub struct WpObjectClass {
    ...
    pub activate_get_next_step: Option<
        unsafe extern "C" fn(
            *mut WpObject,
            *mut WpFeatureActivationTransition,
            c_uint,
            WpObjectFeatures,
        ) -> c_uint,
    >,
    pub activate_execute_step: Option<
        unsafe extern "C" fn(
            *mut WpObject,
            *mut WpFeatureActivationTransition,
            c_uint,
...
pub struct WpPipewireObjectInterface {
    ...
    pub set_param: Option<
        unsafe extern "C" fn(*mut WpPipewireObject, *const c_char, u32, *mut WpSpaPod) -> gboolean,
    >,
    pub _wp_padding: [gpointer; 5],
}
...
#[repr(C)]
#[allow(dead_code)]
pub struct WpProcInfo {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

impl ::std::fmt::Debug for WpProcInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpProcInfo @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpProperties {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpProperties @ {self:p}")).finish()
    }
}
...
pub struct WpSiAcquisitionInterface {
    ...
    >,
    pub release:
        Option<unsafe extern "C" fn(*mut WpSiAcquisition, *mut WpSiLink, *mut WpSiLinkable)>,
    pub _wp_padding: [gpointer; 5],
}
...
pub struct WpSiAdapterInterface {
    pub interface: gobject::GTypeInterface,
    pub get_ports_format:
        Option<unsafe extern "C" fn(*mut WpSiAdapter, *mut *const c_char) -> *mut WpSpaPod>,
    pub set_ports_format: Option<
        unsafe extern "C" fn(
            *mut WpSiAdapter,
            *mut WpSpaPod,
            *const c_char,
    ...
    >,
    pub set_ports_format_finish: Option<
        unsafe extern "C" fn(
            *mut WpSiAdapter,
            *mut gio::GAsyncResult,
            *mut *mut glib::GError,
...
pub struct WpSiFactoryClass {
    pub parent_class: gobject::GObjectClass,
    pub construct:
        Option<unsafe extern "C" fn(*mut WpSiFactory, *mut WpCore) -> *mut WpSessionItem>,
...
pub struct WpSiLinkableInterface {
    pub interface: gobject::GTypeInterface,
    pub get_ports:
        Option<unsafe extern "C" fn(*mut WpSiLinkable, *const c_char) -> *mut glib::GVariant>,
...
impl ::std::fmt::Debug for WpSpaJson {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpSpaJson @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpSpaPod {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpSpaPod @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpClient {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpClient @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpConf {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpConf @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpCore {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpCore @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpDevice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpDevice @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpFactory {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpFactory @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpImplModule {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpImplModule @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpImplNode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpImplNode @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpLink {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpLink @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpNode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpNode @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpPort {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpPort @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpSettings {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpSettings @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpSpaDevice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpSpaDevice @ {self:p}")).finish()
    }
}

#[repr(C)]
#[allow(dead_code)]
pub struct WpSpaType {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

impl ::std::fmt::Debug for WpSpaType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpSpaType @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for WpState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("WpState @ {self:p}")).finish()
    }
}
...
extern "C" {
    ...
    pub fn wp_event_new(
        ...
        subject: *mut gobject::GObject,
    ) -> *mut WpEvent;
    pub fn wp_event_collect_hooks(
        event: *mut WpEvent,
        dispatcher: *mut WpEventDispatcher,
    ) -> gboolean;
    ...
    pub fn wp_iterator_new(methods: *const WpIteratorMethods, user_size: size_t)
        -> *mut WpIterator;
    pub fn wp_iterator_new_ptr_array(
        items: *mut glib::GPtrArray,
        item_type: GType,
    ) -> *mut WpIterator;
    pub fn wp_iterator_fold(
        self_: *mut WpIterator,
        func: WpIteratorFoldFunc,
        ret: *mut gobject::GValue,
        data: gpointer,
    ) -> gboolean;
    pub fn wp_iterator_foreach(
        self_: *mut WpIterator,
        func: WpIteratorForeachFunc,
        data: gpointer,
    ) -> gboolean;
    ...
    pub fn wp_object_interest_add_constraint(
    ...
    pub fn wp_object_interest_matches_full(
        self_: *mut WpObjectInterest,
    ...
    pub fn wp_object_interest_validate(
        self_: *mut WpObjectInterest,
    ...
    // WpProcInfo
    //=========================================================================
    pub fn wp_proc_info_get_type() -> GType;
    pub fn wp_proc_info_get_arg(self_: *mut WpProcInfo, index: c_uint) -> *const c_char;
    pub fn wp_proc_info_get_cgroup(self_: *mut WpProcInfo) -> *const c_char;
    pub fn wp_proc_info_get_n_args(self_: *mut WpProcInfo) -> c_uint;
    pub fn wp_proc_info_get_parent_pid(self_: *mut WpProcInfo) -> pid_t;
    pub fn wp_proc_info_get_pid(self_: *mut WpProcInfo) -> pid_t;
    pub fn wp_proc_info_ref(self_: *mut WpProcInfo) -> *mut WpProcInfo;
    pub fn wp_proc_info_unref(self_: *mut WpProcInfo);
    ...
    pub fn wp_properties_add_keys(
        self_: *mut WpProperties,
        props: *mut WpProperties,
        key1: *const c_char,
        ...
    ) -> c_int;
    pub fn wp_properties_add_keys_array(
        self_: *mut WpProperties,
        props: *mut WpProperties,
        keys: *mut *const c_char,
    ) -> c_int;
    pub fn wp_properties_add_keys_from_dict(
        self_: *mut WpProperties,
        dict: *const spa_dict,
        key1: *const c_char,
        ...
    ...
    pub fn wp_properties_unref_and_take_pw_properties(
        self_: *mut WpProperties,
    ) -> *mut pw_properties;
    pub fn wp_properties_update(self_: *mut WpProperties, props: *mut WpProperties) -> c_int;
    pub fn wp_properties_update_from_dict(self_: *mut WpProperties, dict: *const spa_dict)
        -> c_int;
    pub fn wp_properties_update_from_json(
        self_: *mut WpProperties,
        json: *const WpSpaJson,
    ) -> c_int;
    pub fn wp_properties_update_keys(
        self_: *mut WpProperties,
        props: *mut WpProperties,
        key1: *const c_char,
        ...
    ) -> c_int;
    pub fn wp_properties_update_keys_array(
        self_: *mut WpProperties,
        props: *mut WpProperties,
        keys: *mut *const c_char,
    ) -> c_int;
    pub fn wp_properties_update_keys_from_dict(
        self_: *mut WpProperties,
        dict: *const spa_dict,
        key1: *const c_char,
        ...
    ...
    pub fn wp_settings_spec_check_value(
        self_: *mut WpSettingsSpec,
        value: *mut WpSpaJson,
    ) -> gboolean;
    ...
    pub fn wp_settings_spec_get_name(self_: *mut WpSettingsSpec) -> *const c_char;
    ...
    pub fn wp_spa_json_new_object(key: *const c_char, format: *const c_char, ...)
        -> *mut WpSpaJson;
    ...
    pub fn wp_spa_json_builder_add_from_string(
        self_: *mut WpSpaJsonBuilder,
        json_str: *const c_char,
    );
    pub fn wp_spa_json_builder_add_from_stringn(
        self_: *mut WpSpaJsonBuilder,
        json_str: *const c_char,
        len: size_t,
    );
    ...
    pub fn wp_spa_json_parser_get_boolean(
        self_: *mut WpSpaJsonParser,
        value: *mut gboolean,
    ) -> gboolean;
    pub fn wp_spa_json_parser_get_float(
        self_: *mut WpSpaJsonParser,
        value: *mut c_float,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_get_bytes(
        self_: *mut WpSpaPod,
        value: *mut gconstpointer,
        len: *mut u32,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_get_control(
        self_: *mut WpSpaPod,
        offset: *mut u32,
        ctl_type: *mut *const c_char,
        value: *mut *mut WpSpaPod,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_get_fraction(
        self_: *mut WpSpaPod,
        num: *mut u32,
        denom: *mut u32,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_get_object(
        self_: *mut WpSpaPod,
        id_name: *mut *const c_char,
        ...
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_get_property(
        self_: *mut WpSpaPod,
        key: *mut *const c_char,
        value: *mut *mut WpSpaPod,
    ) -> gboolean;
    pub fn wp_spa_pod_get_rectangle(
        self_: *mut WpSpaPod,
        width: *mut u32,
        height: *mut u32,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_builder_add_bytes(
        self_: *mut WpSpaPodBuilder,
        value: gconstpointer,
        len: u32,
    );
    pub fn wp_spa_pod_builder_add_control(
        self_: *mut WpSpaPodBuilder,
        offset: u32,
        ctl_type: *const c_char,
    );
    ...
    pub fn wp_spa_pod_builder_add_pointer(
        self_: *mut WpSpaPodBuilder,
        type_name: *const c_char,
        value: gconstpointer,
    );
    ...
    pub fn wp_spa_pod_parser_new_object(
        pod: *mut WpSpaPod,
        id_name: *mut *const c_char,
    ) -> *mut WpSpaPodParser;
    ...
    pub fn wp_spa_pod_parser_get_boolean(
        self_: *mut WpSpaPodParser,
        value: *mut gboolean,
    ) -> gboolean;
    pub fn wp_spa_pod_parser_get_bytes(
        self_: *mut WpSpaPodParser,
        value: *mut gconstpointer,
        len: *mut u32,
    ) -> gboolean;
    pub fn wp_spa_pod_parser_get_double(
        self_: *mut WpSpaPodParser,
        value: *mut c_double,
    ) -> gboolean;
    pub fn wp_spa_pod_parser_get_fd(self_: *mut WpSpaPodParser, value: *mut i64) -> gboolean;
    pub fn wp_spa_pod_parser_get_float(self_: *mut WpSpaPodParser, value: *mut c_float)
        -> gboolean;
    pub fn wp_spa_pod_parser_get_fraction(
        self_: *mut WpSpaPodParser,
        num: *mut u32,
        denom: *mut u32,
    ) -> gboolean;
    ...
    pub fn wp_spa_pod_parser_get_pointer(
        self_: *mut WpSpaPodParser,
        value: *mut gconstpointer,
    ) -> gboolean;
    pub fn wp_spa_pod_parser_get_rectangle(
        self_: *mut WpSpaPodParser,
        width: *mut u32,
        height: *mut u32,
    ) -> gboolean;
    pub fn wp_spa_pod_parser_get_string(
        self_: *mut WpSpaPodParser,
    ...
    pub fn wp_async_event_hook_new(
        name: *const c_char,
        before: *mut *const c_char,
        after: *mut *const c_char,
        get_next_step: *mut gobject::GClosure,
        execute_step: *mut gobject::GClosure,
    ) -> *mut WpEventHook;
    ...
    pub fn wp_client_update_permissions_array(
        self_: *mut WpClient,
        n_perm: c_uint,
        permissions: *const c_void,
    );
    ...
    pub fn wp_conf_section_update_props(
        self_: *mut WpConf,
    ...
    #[cfg(feature = "v0_5_6")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_5_6")))]
    pub fn wp_core_connect_fd(self_: *mut WpCore, fd: c_int) -> gboolean;
    pub fn wp_core_disconnect(self_: *mut WpCore);
    pub fn wp_core_find_object(
        self_: *mut WpCore,
        func: glib::GEqualFunc,
        data: gconstpointer,
    ) -> *mut gobject::GObject;
    ...
    pub fn wp_core_idle_add_closure(
        self_: *mut WpCore,
        source: *mut *mut glib::GSource,
    ...
    pub fn wp_core_load_component(
        self_: *mut WpCore,
        component: *const c_char,
        type_: *const c_char,
        args: *mut WpSpaJson,
        provides: *const c_char,
        cancellable: *mut gio::GCancellable,
        callback: gio::GAsyncReadyCallback,
        data: gpointer,
    );
    pub fn wp_core_load_component_finish(
        self_: *mut WpCore,
    ...
    pub fn wp_core_sync_closure(
        self_: *mut WpCore,
        cancellable: *mut gio::GCancellable,
        closure: *mut gobject::GClosure,
    ) -> gboolean;
    pub fn wp_core_sync_finish(
        self_: *mut WpCore,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn wp_core_test_feature(self_: *mut WpCore, feature: *const c_char) -> gboolean;
    pub fn wp_core_timeout_add(
        self_: *mut WpCore,
        source: *mut *mut glib::GSource,
        timeout_ms: c_uint,
        function: glib::GSourceFunc,
    ...
    pub fn wp_core_timeout_add_closure(
        self_: *mut WpCore,
        source: *mut *mut glib::GSource,
        timeout_ms: c_uint,
        closure: *mut gobject::GClosure,
    ...
    pub fn wp_device_new_from_factory(
        core: *mut WpCore,
    ...
    pub fn wp_event_dispatcher_new_hooks_iterator(self_: *mut WpEventDispatcher)
        -> *mut WpIterator;
    ...
    pub fn wp_event_dispatcher_unregister_hook(
        self_: *mut WpEventDispatcher,
        hook: *mut WpEventHook,
    );
    ...
    pub fn wp_event_hook_finish(
        self_: *mut WpEventHook,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    ...
    pub fn wp_event_hook_set_dispatcher(
        self_: *mut WpEventHook,
        dispatcher: *mut WpEventDispatcher,
    );
    ...
    pub fn wp_feature_activation_transition_get_requested_features(
        self_: *mut WpFeatureActivationTransition,
    ) -> WpObjectFeatures;
    ...
    pub fn wp_impl_metadata_new_full(
        core: *mut WpCore,
        name: *const c_char,
        properties: *mut WpProperties,
    ) -> *mut WpImplMetadata;
    ...
    pub fn wp_impl_node_new_from_pw_factory(
        core: *mut WpCore,
        factory_name: *const c_char,
        properties: *mut WpProperties,
    ) -> *mut WpImplNode;
    ...
    pub fn wp_interest_event_hook_add_interest_full(
        self_: *mut WpInterestEventHook,
    ...
    pub fn wp_link_new_from_factory(
        core: *mut WpCore,
        factory_name: *const c_char,
        properties: *mut WpProperties,
    ) -> *mut WpLink;
    pub fn wp_link_get_linked_object_ids(
        self_: *mut WpLink,
        output_node: *mut u32,
        output_port: *mut u32,
        input_node: *mut u32,
    ...
    pub fn wp_node_new_from_factory(
        core: *mut WpCore,
        factory_name: *const c_char,
        properties: *mut WpProperties,
    ) -> *mut WpNode;
    ...
    pub fn wp_node_lookup_port_full(
        self_: *mut WpNode,
        interest: *mut WpObjectInterest,
    ) -> *mut WpPort;
    pub fn wp_node_new_ports_filtered_iterator(self_: *mut WpNode, ...) -> *mut WpIterator;
    pub fn wp_node_new_ports_filtered_iterator_full(
        self_: *mut WpNode,
        interest: *mut WpObjectInterest,
    ) -> *mut WpIterator;
    ...
    pub fn wp_object_activate(
        self_: *mut WpObject,
        features: WpObjectFeatures,
        cancellable: *mut gio::GCancellable,
        callback: gio::GAsyncReadyCallback,
        user_data: gpointer,
    );
    pub fn wp_object_activate_closure(
        self_: *mut WpObject,
        features: WpObjectFeatures,
        cancellable: *mut gio::GCancellable,
        closure: *mut gobject::GClosure,
    ...
    pub fn wp_object_test_active_features(
        self_: *mut WpObject,
        features: WpObjectFeatures,
    ) -> gboolean;
    pub fn wp_object_test_supported_features(
        self_: *mut WpObject,
        features: WpObjectFeatures,
    ) -> gboolean;
    pub fn wp_object_update_features(
        self_: *mut WpObject,
    ...
    pub fn wp_object_manager_lookup(
        self_: *mut WpObjectManager,
        gtype: GType,
        ...
    ) -> *mut gobject::GObject;
    pub fn wp_object_manager_lookup_full(
        self_: *mut WpObjectManager,
        interest: *mut WpObjectInterest,
    ) -> *mut gobject::GObject;
    pub fn wp_object_manager_maybe_objects_changed(self_: *mut WpObjectManager);
    pub fn wp_object_manager_new_filtered_iterator(
        self_: *mut WpObjectManager,
        gtype: GType,
        ...
    ) -> *mut WpIterator;
    pub fn wp_object_manager_new_filtered_iterator_full(
        self_: *mut WpObjectManager,
        interest: *mut WpObjectInterest,
    ) -> *mut WpIterator;
    ...
    pub fn wp_object_manager_request_object_features(
        self_: *mut WpObjectManager,
        object_type: GType,
        wanted_features: WpObjectFeatures,
    );
    ...
    pub fn wp_session_item_make(
        core: *mut WpCore,
        factory_name: *const c_char,
    ) -> *mut WpSessionItem;
    pub fn wp_session_item_configure(
        self_: *mut WpSessionItem,
        props: *mut WpProperties,
    ) -> gboolean;
    pub fn wp_session_item_get_associated_proxy(
        self_: *mut WpSessionItem,
        proxy_type: GType,
    ) -> *mut WpProxy;
    pub fn wp_session_item_get_associated_proxy_id(
        self_: *mut WpSessionItem,
        proxy_type: GType,
    ) -> u32;
    pub fn wp_session_item_get_properties(self_: *mut WpSessionItem) -> *mut WpProperties;
    pub fn wp_session_item_get_property(
        self_: *mut WpSessionItem,
        key: *const c_char,
    ) -> *const c_char;
    ...
    pub fn wp_settings_get_spec(self_: *mut WpSettings, name: *const c_char)
        -> *mut WpSettingsSpec;
    ...
    pub fn wp_settings_set(
        self_: *mut WpSettings,
        name: *const c_char,
        value: *mut WpSpaJson,
    ) -> gboolean;
    pub fn wp_settings_subscribe(
        self_: *mut WpSettings,
        pattern: *const c_char,
        callback: WpSettingsChangedCallback,
        user_data: gpointer,
    ) -> uintptr_t;
    pub fn wp_settings_subscribe_closure(
        self_: *mut WpSettings,
        pattern: *const c_char,
        closure: *mut gobject::GClosure,
    ) -> uintptr_t;
    ...
    pub fn wp_simple_event_hook_new(
        name: *const c_char,
        before: *mut *const c_char,
        after: *mut *const c_char,
        closure: *mut gobject::GClosure,
    ...
    pub fn wp_spa_device_new_from_spa_factory(
        core: *mut WpCore,
        factory_name: *const c_char,
        properties: *mut WpProperties,
    ) -> *mut WpSpaDevice;
    pub fn wp_spa_device_new_wrap(
        core: *mut WpCore,
        spa_device_handle: gpointer,
        properties: *mut WpProperties,
    ) -> *mut WpSpaDevice;
    pub fn wp_spa_device_get_managed_object(
        self_: *mut WpSpaDevice,
        id: c_uint,
    ) -> *mut gobject::GObject;
    ...
    pub fn wp_spa_device_set_managed_pending(self_: *mut WpSpaDevice, id: c_uint);
    pub fn wp_spa_device_store_managed_object(
        self_: *mut WpSpaDevice,
        id: c_uint,
        object: *mut gobject::GObject,
    );
    ...
    pub fn wp_state_save(
        self_: *mut WpState,
        props: *mut WpProperties,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn wp_state_save_after_timeout(
        self_: *mut WpState,
        core: *mut WpCore,
        props: *mut WpProperties,
    );
    ...
    pub fn wp_transition_new_closure(
        type_: GType,
        source_object: *mut gobject::GObject,
        cancellable: *mut gio::GCancellable,
        closure: *mut gobject::GClosure,
    ) -> *mut WpTransition;
    pub fn wp_transition_finish(
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    ...
    pub fn wp_transition_set_data(
        self_: *mut WpTransition,
        data: gpointer,
    ...
    pub fn wp_pipewire_object_enum_params(
    ...
    pub fn wp_pipewire_object_enum_params_finish(
        self_: *mut WpPipewireObject,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> *mut WpIterator;
    pub fn wp_pipewire_object_enum_params_sync(
        self_: *mut WpPipewireObject,
        id: *const c_char,
        filter: *mut WpSpaPod,
    ) -> *mut WpIterator;
    ...
    pub fn wp_pipewire_object_new_properties_iterator(
        self_: *mut WpPipewireObject,
    ) -> *mut WpIterator;
    ...
    pub fn wp_si_acquisition_acquire(
        self_: *mut WpSiAcquisition,
        acquisitor: *mut WpSiLink,
        item: *mut WpSiLinkable,
        callback: gio::GAsyncReadyCallback,
        data: gpointer,
    );
    pub fn wp_si_acquisition_acquire_finish(
        self_: *mut WpSiAcquisition,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn wp_si_acquisition_release(
        self_: *mut WpSiAcquisition,
        acquisitor: *mut WpSiLink,
        item: *mut WpSiLinkable,
    );
    ...
    pub fn wp_si_adapter_get_ports_format(
        self_: *mut WpSiAdapter,
        mode: *mut *const c_char,
    ) -> *mut WpSpaPod;
    pub fn wp_si_adapter_get_ports_state(self_: *mut WpSiAdapter) -> WpSiAdapterPortsState;
    pub fn wp_si_adapter_set_ports_format(
        self_: *mut WpSiAdapter,
        format: *mut WpSpaPod,
        mode: *const c_char,
        callback: gio::GAsyncReadyCallback,
    ...
    pub fn wp_si_adapter_set_ports_format_finish(
        self_: *mut WpSiAdapter,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    ...
    pub fn wp_si_linkable_get_ports(
        self_: *mut WpSiLinkable,
    ...
    // Other functions
    //=========================================================================
    pub fn wp_base_dirs_find_file(
        flags: WpBaseDirsFlags,
        subdir: *const c_char,
        filename: *const c_char,
    ) -> *mut c_char;
    pub fn wp_base_dirs_new_files_iterator(
        flags: WpBaseDirsFlags,
        subdir: *const c_char,
        suffix: *const c_char,
    ) -> *mut WpIterator;
    ...
    pub fn wp_json_utils_match_rules(
        json: *mut WpSpaJson,
        match_props: *mut WpProperties,
        callback: WpRuleMatchCallback,
        data: gpointer,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn wp_json_utils_match_rules_update_properties(
        json: *mut WpSpaJson,
        props: *mut WpProperties,
    ) -> c_int;
    pub fn wp_json_utils_merge_containers(a: *mut WpSpaJson, b: *mut WpSpaJson) -> *mut WpSpaJson;
    pub fn wp_log_checked(
        log_topic: *const c_char,
        log_level: glib::GLogLevelFlags,
        file: *const c_char,
        line: *const c_char,
        func: *const c_char,
        object_type: GType,
    ...
    pub fn wp_log_writer_default(
        log_level: glib::GLogLevelFlags,
        fields: *const glib::GLogField,
        n_fields: size_t,
        user_data: gpointer,
    ) -> glib::GLogWriterOutput;
    pub fn wp_logt_checked(
        topic: *const WpLogTopic,
        log_level: glib::GLogLevelFlags,
        file: *const c_char,
        line: *const c_char,
        func: *const c_char,
    ...
    pub fn wp_proc_utils_get_proc_info(pid: pid_t) -> *mut WpProcInfo;
    pub fn wp_spa_dynamic_id_table_register(
        name: *const c_char,
        values: *const spa_type_info,
    ) -> WpSpaIdTable;
    pub fn wp_spa_dynamic_type_deinit();
    pub fn wp_spa_dynamic_type_init();
    pub fn wp_spa_dynamic_type_register(
        name: *const c_char,
        parent: WpSpaType,
        values: *const spa_type_info,
    ) -> WpSpaType;
    pub fn wp_spa_id_table_find_value(table: WpSpaIdTable, value: c_uint) -> WpSpaIdValue;
    pub fn wp_spa_id_table_find_value_from_name(
        table: WpSpaIdTable,
        name: *const c_char,
    ) -> WpSpaIdValue;
    pub fn wp_spa_id_table_find_value_from_short_name(
        table: WpSpaIdTable,
    ...
    pub fn wp_spa_id_value_array_get_item_type(
        id: WpSpaIdValue,
        table: *mut WpSpaIdTable,
    ) -> WpSpaType;
    ...
    pub fn wp_spa_id_value_from_short_name(
