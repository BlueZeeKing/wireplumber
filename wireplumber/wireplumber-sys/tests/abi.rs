...
static PACKAGES: &[&str] = &["wireplumber-0.5"];
...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ("WpAsyncEventHookClass", Layout {size: size_of::<WpAsyncEventHookClass>(), alignment: align_of::<WpAsyncEventHookClass>()}),
    ("WpBaseDirsFlags", Layout {size: size_of::<WpBaseDirsFlags>(), alignment: align_of::<WpBaseDirsFlags>()}),
    ("WpClientClass", Layout {size: size_of::<WpClientClass>(), alignment: align_of::<WpClientClass>()}),
    ("WpComponentLoaderInterface", Layout {size: size_of::<WpComponentLoaderInterface>(), alignment: align_of::<WpComponentLoaderInterface>()}),
    ("WpConfClass", Layout {size: size_of::<WpConfClass>(), alignment: align_of::<WpConfClass>()}),
    ...
    ("WpCoreFeatures", Layout {size: size_of::<WpCoreFeatures>(), alignment: align_of::<WpCoreFeatures>()}),
    ...
    ("WpEventDispatcherClass", Layout {size: size_of::<WpEventDispatcherClass>(), alignment: align_of::<WpEventDispatcherClass>()}),
    ("WpEventHook", Layout {size: size_of::<WpEventHook>(), alignment: align_of::<WpEventHook>()}),
    ("WpEventHookClass", Layout {size: size_of::<WpEventHookClass>(), alignment: align_of::<WpEventHookClass>()}),
    ...
    ("WpInterestEventHook", Layout {size: size_of::<WpInterestEventHook>(), alignment: align_of::<WpInterestEventHook>()}),
    ("WpInterestEventHookClass", Layout {size: size_of::<WpInterestEventHookClass>(), alignment: align_of::<WpInterestEventHookClass>()}),
    ...
    ("WpLogTopic", Layout {size: size_of::<WpLogTopic>(), alignment: align_of::<WpLogTopic>()}),
    ("WpLogTopicFlags", Layout {size: size_of::<WpLogTopicFlags>(), alignment: align_of::<WpLogTopicFlags>()}),
    ...
    ("WpSettingsClass", Layout {size: size_of::<WpSettingsClass>(), alignment: align_of::<WpSettingsClass>()}),
    ("WpSettingsFeatures", Layout {size: size_of::<WpSettingsFeatures>(), alignment: align_of::<WpSettingsFeatures>()}),
    ("WpSettingsSpecType", Layout {size: size_of::<WpSettingsSpecType>(), alignment: align_of::<WpSettingsSpecType>()}),
    ...
    ("WpSimpleEventHookClass", Layout {size: size_of::<WpSimpleEventHookClass>(), alignment: align_of::<WpSimpleEventHookClass>()}),
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("(guint) WP_BASE_DIRS_BUILD_DATADIR", "8192"),
    ("(guint) WP_BASE_DIRS_BUILD_LIBDIR", "16384"),
    ("(guint) WP_BASE_DIRS_BUILD_SYSCONFDIR", "2048"),
    ("(guint) WP_BASE_DIRS_CONFIGURATION", "33570049"),
    ("(guint) WP_BASE_DIRS_DATA", "33567234"),
    ("(guint) WP_BASE_DIRS_ENV_CONFIG", "1"),
    ("(guint) WP_BASE_DIRS_ENV_DATA", "2"),
    ("(guint) WP_BASE_DIRS_ENV_MODULE", "4"),
    ("(guint) WP_BASE_DIRS_FLAG_MODULE", "16777216"),
    ("(guint) WP_BASE_DIRS_FLAG_SUBDIR_WIREPLUMBER", "33554432"),
    ("(guint) WP_BASE_DIRS_MODULE", "50348036"),
    ("(guint) WP_BASE_DIRS_XDG_CONFIG_DIRS", "1024"),
    ("(guint) WP_BASE_DIRS_XDG_CONFIG_HOME", "256"),
    ("(guint) WP_BASE_DIRS_XDG_DATA_DIRS", "4096"),
    ("(guint) WP_BASE_DIRS_XDG_DATA_HOME", "512"),
    ...
    ("(guint) WP_CORE_FEATURE_COMPONENTS", "2"),
    ("(guint) WP_CORE_FEATURE_CONNECTED", "1"),
    ...
    ("(guint) WP_INTEREST_MATCH_ALL", "15"),
    ...
    ("(gint) WP_LIBRARY_ERROR_SERVICE_UNAVAILABLE", "3"),
    ...
    ("(guint) WP_LOG_TOPIC_FLAG_INITIALIZED", "2147483648"),
    ("(guint) WP_LOG_TOPIC_FLAG_STATIC", "1073741824"),
    ("(guint) WP_LOG_TOPIC_LEVEL_MASK", "65535"),
    ...
    ("(guint) WP_PIPEWIRE_OBJECT_FEATURES_ALL", "1009"),
    ("(guint) WP_PIPEWIRE_OBJECT_FEATURES_MINIMAL", "17"),
    ...
    ("(guint) WP_SETTINGS_LOADED", "1"),
    ("WP_SETTINGS_PERSISTENT_METADATA_NAME_PREFIX", "persistent-"),
    ("WP_SETTINGS_SCHEMA_METADATA_NAME_PREFIX", "schema-"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_ARRAY", "5"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_BOOL", "1"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_FLOAT", "3"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_INT", "2"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_OBJECT", "6"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_STRING", "4"),
    ("(gint) WP_SETTINGS_SPEC_TYPE_UNKNOWN", "0"),
