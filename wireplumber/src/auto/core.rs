...
use crate::{ffi,Conf,Object,ObjectManager,Properties};
use glib::{object::ObjectType as _,prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_,pin::Pin};

glib::wrapper! {
    #[doc(alias = "WpCore")]
    pub struct Core(Object<ffi::WpCore, ffi::WpCoreClass>) @extends Object;
...
impl Core {
    ...
    pub fn new(context: Option<&glib::MainContext>, conf: Option<Conf>, properties: Option<Properties>) -> Core {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::wp_core_new(context.to_glib_none().0, conf.into_glib_ptr(), properties.into_glib_ptr()))
        }
    }
...
#[must_use]
    ...
    #[doc(alias = "wp_core_connect_fd")]
    pub fn connect_fd(&self, fd: i32) -> bool {
        unsafe {
            from_glib(ffi::wp_core_connect_fd(self.to_glib_none().0, fd))
        }
    }
    ...
    //#[doc(alias = "wp_core_find_object")]
    //pub fn find_object(&self, func: /*Unimplemented*/FnMut(/*Unimplemented*/Option<Basic: Pointer>) -> bool, data: /*Unimplemented*/Option<Basic: Pointer>) -> Option<glib::Object> {
    //    unsafe { TODO: call ffi:wp_core_find_object() }
    //}

    #[doc(alias = "wp_core_get_conf")]
    #[doc(alias = "get_conf")]
    pub fn conf(&self) -> Option<Conf> {
        unsafe {
            from_glib_full(ffi::wp_core_get_conf(self.to_glib_none().0))
        }
    }

    #[doc(alias = "wp_core_get_export_core")]
    #[doc(alias = "get_export_core")]
#[must_use]
    pub fn export_core(&self) -> Option<Core> {
        unsafe {
            from_glib_full(ffi::wp_core_get_export_core(self.to_glib_none().0))
        }
    }

    #[doc(alias = "wp_core_get_g_main_context")]
    #[doc(alias = "get_g_main_context")]
    #[doc(alias = "g-main-context")]
    ...
    //pub fn load_component<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, component: Option<&str>, type_: &str, args: /*Ignored*/Option<&SpaJson>, provides: Option<&str>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
    //    unsafe { TODO: call ffi:wp_core_load_component() }
    //}

    //
    //pub fn load_component_future(&self, component: Option<&str>, type_: &str, args: /*Ignored*/Option<&SpaJson>, provides: Option<&str>) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>> {

        //let component = component.map(ToOwned::to_owned);
        //let type_ = String::from(type_);
        //let args = args.map(ToOwned::to_owned);
        //let provides = provides.map(ToOwned::to_owned);
        //Box_::pin(gio::GioFuture::new(self, move |obj, cancellable, send| {
        //    obj.load_component(
        //        component.as_ref().map(::std::borrow::Borrow::borrow),
        //        &type_,
        //        args.as_ref().map(::std::borrow::Borrow::borrow),
        //        provides.as_ref().map(::std::borrow::Borrow::borrow),
        //        Some(cancellable),
        //        move |res| {
        //            send.resolve(res);
        //        },
    ...
    #[doc(alias = "wp_core_register_object")]
    pub fn register_object(&self, obj: impl IsA<glib::Object>) {
        unsafe {
            ffi::wp_core_register_object(self.to_glib_none().0, obj.upcast().into_glib_ptr());
        }
    }

    #[doc(alias = "wp_core_remove_object")]
    pub fn remove_object(&self, obj: &impl IsA<glib::Object>) {
        unsafe {
            ffi::wp_core_remove_object(self.to_glib_none().0, obj.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn sync<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) -> bool {
        ...
        unsafe extern "C" fn sync_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            ...
            ffi::wp_core_sync_finish(_source_object as *mut _, res, &mut error);
    ...
    #[doc(alias = "wp_core_test_feature")]
    pub fn test_feature(&self, feature: &str) -> bool {
        unsafe {
            from_glib(ffi::wp_core_test_feature(self.to_glib_none().0, feature.to_glib_none().0))
        }
    }
    ...
    pub fn connect_connected<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"connected".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(connected_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_disconnected<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"disconnected".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(disconnected_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_pw_core_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::pw-core".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_pw_core_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
